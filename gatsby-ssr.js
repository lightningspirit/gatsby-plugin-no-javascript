...
function onPreRenderHTML(_a, pluginOptions) {
    ...
    if (process.env.NODE_ENV !== 'production'
        || (utilities_1.checkPathExclusion(pathname, pluginOptions) &&
            !utilities_1.checkPathInclusion(pathname, pluginOptions))) { // During a gatsby development build (gatsby develop) we do nothing.
        return;
    }
